...
<template>
  <fieldset
    class="fieldset flex flex-col gap-5 p-4 bg-base-100 border border-base-300 rounded-box w-full">
    <legend class="fieldset-legend text-xl">Size</legend>
    <div class="flex gap-2 flex-wrap">
      <label
        v-for="size in sellerProductStore.sizesConfig"
