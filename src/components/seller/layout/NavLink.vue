...
<template>
  <button
    class="flex items-center gap-5 p-4 h-15 rounded-lg text-white cursor-pointer hover:text-black hover:bg-white transition duration-500 fill-white hover:fill-black"
