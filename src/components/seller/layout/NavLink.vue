...
<template>
  <RouterLink :to="path">
    <div
      class="flex items-center gap-5 p-4 rounded-lg text-white hover:text-black hover:bg-white transition duration-500 fill-white hover:fill-black">
      <svg
        v-if="name === 'Dashboard'"
      ...
      <svg
        v-else-if="name === 'Product Management'"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 576 512"
        class="size-[1rem]">
        <path
      ...
      <svg
        v-else-if="name === 'Order Management'"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 384 512"
        class="size-[1rem]">
        <path
      ...
      <svg v-else-if="name === 'Logout'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="size-[1rem]">
        <path
